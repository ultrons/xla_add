...
from .initialize import get_args

def _initialize_affine_weight(*args):
    init_args = get_args()
    if init_args.use_cpu_initialization:
        return _initialize_affine_weight_cpu(*args)
    else:
        return _initialize_affine_weight_gpu(*args)
